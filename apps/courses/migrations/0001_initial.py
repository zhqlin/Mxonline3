    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('course', models.ForeignKey(on_delete='CASCADE', to='courses.Course', verbose_name='课程')),
            ],
            options={
                'verbose_name': '课程资源',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('lesson', models.ForeignKey(on_delete='CASCADE', to='courses.Lesson', verbose_name='章节')),
            ],
            options={
                'verbose_name': '视频',
